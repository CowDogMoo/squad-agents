...
- Phase 1+2 (Discover+Analyze) MUST complete in ≤4 iterations. Batch reads aggressively.
- If ALL findings are INFO/theoretical after reading, skip Phase 3 and emit report IMMEDIATELY
...
- NEVER use Bash to run cat, find, head, tail — use Read and Glob tools instead
